...
#| cache=TRUE,
#| echo=FALSE,
#| eval=opts_current$get('doi') %>% is.null() %>% not(),
#| results='asis',
# title='References'
# title_depth=2
...
sprintf(fmt='cd %s ; academic import --bibtex %s/scratch/bibliography.bib --publication-dir publication --no-overwrite', project.notes.tools:::project_paths$website, project.notes.tools:::project_paths$knitting) %>%
