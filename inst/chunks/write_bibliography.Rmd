...
# decide if there is anything to do
length(bibliography_doi) %>%
  is_greater_than(0) %>%
  if_else(true=TRUE, false=FALSE) -> bibliography_defined

# if there is a bibliography to write and print
if(bibliography_defined) {
