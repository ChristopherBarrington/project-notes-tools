...
#
# file.rename(from='files/software.bib', to='files/software.bibtex') %>% invisible()
...
#
#   file.rename(from='files/academic.bib', to='files/academic.bibtex') %>% invisible()
